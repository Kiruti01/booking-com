...
const products = [
    {
        name: "Book a stay",
        description: "Get  better understanding of your traffic",
        href: "#",
        icon: HomeIcon,
    },
    {
  ...
  return ( 
    <header className="bg-[#013B94]">
        ...
        >
            ...
            <Popover.Group className="hidden lg:flex lg:gap-x-12">
                <Popover className="relative">
                    <Popover.Button className="flex items-center gapx-1 text-sm font-semibold leading-6 text-white">
                        Stays
                        <ChevronDownIcon 
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0 translatey-1"
                        ...
                        rounded-3xl shadow-lg ring-1 ring-gray-900/5">
                            <div className="p-4">
                                {products.map((item) => (
                                    <div
                                        key={item.name}
                                        className="group relative flex items-centergap-x-6
                                        rounded-lg p-4 text-sm leading-6 hover:bg-gray-50"
                                    >
                                        <div className="flex h-11 w-11 flex-none
                                        items-center justify-center rounded-lg bg-gray-50
                            ...
                            <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                                {callsToAction.map((item) => (
                                    <a
                                        key={item.name}
                                        href={item.href}
                                        className="flex items-center justify-center gap-x-2.5 text-sm font-semibold leading-6 text-[#013B94]
                                        hover:bg-gray-100"
                                        >
                                            <item.icon 
        ...
        >
            ...
            overflow-auto bg-[#013B94] px-6 sm:max-w-sm sm:ring-1
            sm:ring-gray-900/10">
                ...
                <div className="mt-6 flow-root">
                    <div className="-my-6 divide-y divide-gray-500/10">
                        ...
                        <div className="py-6">
                            <a 
                            href="#" 
                            className="mx-3 bloc rounded-lg px-3 py-2.5 text-base 
